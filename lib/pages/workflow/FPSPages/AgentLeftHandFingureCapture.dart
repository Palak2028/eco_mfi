                          ...
                          children: <Widget>[
                            Expanded(
                              child: new RaisedButton(
                                  ...
                                  onPressed: () async {
                                  await  AppDatabase.get().updateAgentBiometric(beanObj.musrcode, "LH", _AgentLeftHandFingureCapture.agentbioRegLHDATA.toString(), "");
                                    print( "LHDATAAA"+_AgentLeftHandFingureCapture.agentbioRegLHDATA.toString());
                                  }),
                            ),
                          ],
                        ),
...
>>>>>>> .r1143
      ...
      print(
          "lhcv" + _AgentLeftHandFingureCapture.counterAgentLHRegist.toString());
      if (_AgentLeftHandFingureCapture.counterAgentLHRegist < 1) {
        _callChannelLHThumb("LhThumb");
      } else {
        Toast.show("you have already captured Left hand fingers", context);
    ...
    try {
      ...
      if (LHThumbdata != null && LHThumbdata != 'null') {
        setState(() {
          ...
          CustomerFormationMasterTabsState
                .custListBean.imageMaster[13].imgString = LHThumbdata;
          CustomerFormationMasterTabsState
      ...
      if (LHIndexdata != null && LHIndexdata != 'null') {
        setState(() {
          if (userType == "CUSTOMER") {
            ...
            CustomerFormationMasterTabsState
                .custListBean.imageMaster[14].imgString = LHIndexdata;
            CustomerFormationMasterTabsState
      ...
      if (LHMiddledata != null && LHMiddledata != 'null') {
        setState(() {
          if (userType == "CUSTOMER") {
            ...
            CustomerFormationMasterTabsState
                .custListBean.imageMaster[15].imgString = LHMiddledata;
            CustomerFormationMasterTabsState
      ...
      if (LHRingdata != null && LHRingdata != 'null') {
        setState(() {
          if (userType == "CUSTOMER") {
            ...
            CustomerFormationMasterTabsState
                .custListBean.imageMaster[16].imgString = LHRingdata;
            CustomerFormationMasterTabsState
      ...
      if (LHPinkydata != null && LHPinkydata != 'null') {
        setState(() {
          if (userType == "CUSTOMER") {
            ...
            CustomerFormationMasterTabsState
                .custListBean.imageMaster[17].imgString = LHPinkydata;
            CustomerFormationMasterTabsState
