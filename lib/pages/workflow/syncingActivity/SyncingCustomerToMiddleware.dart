          ...
          await AppDatabase.get()
            ...
            if (!isForSingleCustomer) {
              if (obj[cust]!=null && obj[cust].mrefno != null && customerData.mrefno==null || customerData.mrefno == 0) {
                ...
                "${TablesColumnFile.mmobilelastsynsdate} = '${DateTime.now()}' ,${TablesColumnFile.mlastupdatedt} = '${DateTime
                    .now()}' WHERE ${TablesColumnFile.mrefno} = ${obj[cust]
                    .mrefno} AND ${TablesColumnFile.trefno} = ${obj[cust]
                    .trefno}";
              }
            }else{
              if (obj[cust]!=null && obj[cust].mrefno != null && customerData.mrefno==null || customerData.mrefno == 0) {
                ...
                "${TablesColumnFile.mcustno} = ${obj[cust].mcustno},${TablesColumnFile.mmobilelastsynsdate} = '${DateTime.now()}' "
                    ...
                    .mrefno}, ${TablesColumnFile.merrormessage} = '${obj[cust].merrormessage}' , ${TablesColumnFile.mcuststatus} = ${obj[cust].mcuststatus}  "
...
<<<<<<< .mine
                .mrefno}, ${TablesColumnFile.merrormessage} = '${obj[cust].merrormessage}' , ${TablesColumnFile.mcuststatus} =  ${obj[cust].mcuststatus}  WHERE ${TablesColumnFile.trefno} = ${obj[cust].trefno}"
                    " AND ${TablesColumnFile.mrefno} = 0";
=======
                .mrefno}, ${TablesColumnFile.merrormessage} = '${obj[cust].merrormessage}' , ${TablesColumnFile.mcuststatus} =  ${obj[cust].mcuststatus}  WHERE ${TablesColumnFile.trefno} = ${obj[cust].trefno}"
            " AND ${TablesColumnFile.mrefno} = 0";
>>>>>>> .r1143
                ...
                "${TablesColumnFile.mcustno} = ${obj[cust].mcustno}, ${TablesColumnFile.mmobilelastsynsdate} = '${DateTime.now()}' "
                    ",${TablesColumnFile.mlastupdatedt} = '${lastSyncedToServerDaeTime.subtract(Duration(minutes: 1))}' "
                    " , ${TablesColumnFile.merrormessage} = '${obj[cust].merrormessage}' , ${TablesColumnFile.mcuststatus} = ${obj[cust].mcuststatus}  "
                    " WHERE ${TablesColumnFile.mrefno} = ${obj[cust]
                    .mrefno} AND ${TablesColumnFile.trefno} = ${obj[cust]
                    .trefno}":
                "${TablesColumnFile.mcustno} = ${obj[cust].mcustno}, ${TablesColumnFile.mmobilelastsynsdate} = '${DateTime.now()}' "
                    ",${TablesColumnFile.mlastupdatedt} = '${DateTime.now().subtract(Duration(minutes: 1))}' , ${TablesColumnFile.mcuststatus} = ${obj[cust].mcuststatus} WHERE ${TablesColumnFile.mrefno} = ${obj[cust]
                    .mrefno} AND ${TablesColumnFile.trefno} = ${obj[cust]
                    .trefno}"
                ;
              }
...
>>>>>>> .r1143
            ...
            imageList++) {
              if (isSyncingFirstTime) {
                updateImageQuery =
                "${TablesColumnFile.mImgrefno} = ${obj[cust].imageMaster[imageList].mImgrefno},${TablesColumnFile.mrefno} = ${obj[cust].mrefno} WHERE ${TablesColumnFile.trefno} = ${obj[cust].imageMaster[imageList].trefno} AND ${TablesColumnFile.mrefno} = 0";
              } else {
                updateImageQuery =
                "${TablesColumnFile.mImgrefno} = ${obj[cust].imageMaster[imageList].mImgrefno}  WHERE ${TablesColumnFile.mrefno} = ${obj[cust].mrefno} AND ${TablesColumnFile.trefno} = ${obj[cust].imageMaster[imageList].trefno}";
              }
