...
>>>>>>> .r1143
  Future getImage(int no) async {
    ...
    if(no>1 && no<3){
      ...
      CustomerFormationMasterTabsState.custListBean.imageMaster[0].desc=  "PassBook";
    }
...
<<<<<<< .mine
  ...
  Future<Null> getSessionVariables() async {
    ...
    try {
      NIDDEFAULTTYPE = prefs.getInt(TablesColumnFile.NIDDEFAULTTYPE);
      CustomerFormationMasterTabsState.custListBean.mpanno = NIDDEFAULTTYPE;
        setState(() {
        });
    }catch(_){}
  }
                ...
                children: <Widget>[
                  ...
                  isFullerTon==0?new  Padding(
                    ...
                    child: new DropdownButtonFormField(
                      ...
                      //hint:Text("Select"),
                      decoration:
                      InputDecoration(labelText: globals.captionIdType[0]),
