...
//
  ...
  static String syncedLoanCycleParameterPrimaryLab="Loan Cycle Parameter Primary";
  static String syncedLoanCycleSecondaryPrimaryLab="Loan Cycle Parameter Secondary";
...
<<<<<<< .mine
  static assetsVisible(bool isWithReverse, String splitValues) async{
    ...
    await  AppDatabase.get().getLookupDataFromLocalDb(909141).then((onValue){
      globals.dropdownCaptionsValuesCpvMuliselect = List<CheckBoxesChecked>(onValue.length);
          ...
          if (splitValues != null) {
            for (var items in splitValues.split("~")) {
              for (int i = 0; i < globals.dropdownCaptionsValuesCpvMuliselect.length; i++) {
                if (items.trim().contains(globals.dropdownCaptionsValuesCpvMuliselect[i].mquestionid.trim())) {
                  globals.dropdownCaptionsValuesCpvMuliselect[i].manschecked =  1;
                }
              }
            }
            globals.dropdownCaptionsValuesCpvMuliselect =  globals.dropdownCaptionsValuesCpvMuliselect;
          }
        } catch (_) {}
      }
      });
          ...
          if (splitValues != null) {
           // for (var items in splitValues.split("~")) {
            var items = splitValues.split("~");
              for (int i = 0; i < globals.dropdownCaptionsValuesCpvMuliselect.length; i++) {
                print("xxxxxxxxxxxxxxxxxx Problem here in CPV Assets Visible ${globals.dropdownCaptionsValuesCpvMuliselect[i].toString()}");
                if (items.contains(globals.dropdownCaptionsValuesCpvMuliselect[i].mquestionid.trim())) {
                  globals.dropdownCaptionsValuesCpvMuliselect[i].manschecked =  1;
                }else{
...
//social financial
    ...
    //caste
    await  AppDatabase.get().getLookupDataFromLocalDb(48004).then((onValue){//10022
...
//change here --- bhawpriya
    ...
    await  AppDatabase.get().getLookupDataFromLocalDb(909019).then((onValue){//frequency
    ...
    await  AppDatabase.get().getLookupDataFromLocalDb(450058).then((onValue){//buspropownership
    ...
    await  AppDatabase.get().getLookupDataFromLocalDb(450059).then((onValue){//busownership
...
>>>>>>> .r1143
    ...
    lastSyncObj.tlastSyncedToTab=null;
    lastSyncedDateTimeBean.add(lastSyncObj);
    await AppDatabase.get().insertStaticTablesLastSyncedMaster(lastSyncedDateTimeBean, 19);
    lastSyncedDateTimeBean.clear();
    lastSyncObj=null;
    lastSyncObj  = new LastSyncedDateTime();
    lastSyncObj.id=21;
    ...
    lastSyncObj.tlastSyncedToTab=null;
    lastSyncedDateTimeBean.add(lastSyncObj);
    await AppDatabase.get().insertStaticTablesLastSyncedMaster(lastSyncedDateTimeBean, 21);
    //CONTACT POINT VERIFICATION BUSINESS & OFFICE
    lastSyncedDateTimeBean.clear();
    lastSyncObj=null;
    lastSyncObj  = new LastSyncedDateTime();
    ...
    lastSyncObj.tlastSyncedToTab=null;
    lastSyncedDateTimeBean.add(lastSyncObj);
    await AppDatabase.get().insertStaticTablesLastSyncedMaster(lastSyncedDateTimeBean, 22);
    ...
    lastSyncObj.tlastSyncedToTab=null;
    lastSyncedDateTimeBean.add(lastSyncObj);
    await AppDatabase.get().insertStaticTablesLastSyncedMaster(lastSyncedDateTimeBean, 23);
    ...
    lastSyncObj.tlastSyncedToTab=null;
    lastSyncedDateTimeBean.add(lastSyncObj);
    await AppDatabase.get().insertStaticTablesLastSyncedMaster(lastSyncedDateTimeBean, 20);
    ...
    lastSyncObj.tlastSyncedToTab=null;
    lastSyncedDateTimeBean.add(lastSyncObj);
    await AppDatabase.get().insertStaticTablesLastSyncedMaster(lastSyncedDateTimeBean, 24);
    ...
    lastSyncObj.tlastSyncedToTab=null;
    lastSyncedDateTimeBean.add(lastSyncObj);
    await AppDatabase.get().insertStaticTablesLastSyncedMaster(lastSyncedDateTimeBean, 26);
...
>>>>>>> .r1143
    sysBean = new SystemParameterBean();
<<<<<<< .mine
    sysBean = await AppDatabase.get().getSystemParameter(TablesColumnFile.ISINDONUSERCD, 0);
    ...
    sysBean = new SystemParameterBean();
    sysBean = await AppDatabase.get().getSystemParameter(TablesColumnFile.ISGLOONUSERCD, 0);
    if(sysBean !=null&&sysBean.mcodevalue!=null){
      try{
...
>>>>>>> .r1143
    ...
    if(sysBean !=null&&sysBean.mcodevalue!=null){
      prefs.setInt(TablesColumnFile.isWASASA, int.parse(sysBean.mcodevalue.trim()));
    }
    ...
    if(sysBean !=null){
      prefs.setString(
          TablesColumnFile.mCenterRepayFromTo , sysBean.mcodevalue);
    }
...
<<<<<<< .mine
    sysBean = new SystemParameterBean();
    sysBean = await AppDatabase.get().getSystemParameter(TablesColumnFile.ISADDDESC, 0);
    if(sysBean !=null&&sysBean.mcodevalue!=null){
      try{
        prefs.setInt(TablesColumnFile.ISADDDESC, int.parse(sysBean.mcodevalue));
=======
      sysBean = new SystemParameterBean();
      sysBean = await AppDatabase.get().getSystemParameter(TablesColumnFile.ISADDDESC, 0);
      if(sysBean !=null&&sysBean.mcodevalue!=null){
...
>>>>>>> .r1143
      ...
      sysBean = new SystemParameterBean();
      sysBean = await AppDatabase.get().getSystemParameter(TablesColumnFile.lHMinFingCount, 0);
      if(sysBean !=null&&sysBean.mcodevalue!=null){
        try{
          prefs.setInt(TablesColumnFile.lHMinFingCount, int.parse(sysBean.mcodevalue));
        }
        catch(_){
      ...
      sysBean = new SystemParameterBean();
      sysBean = await AppDatabase.get().getSystemParameter(TablesColumnFile.rHMinFingCount, 0);
      if(sysBean !=null&&sysBean.mcodevalue!=null){
        try{
          prefs.setInt(TablesColumnFile.rHMinFingCount, int.parse(sysBean.mcodevalue));
        }
        catch(_){
      ...
      sysBean = new SystemParameterBean();
      sysBean = await AppDatabase.get().getSystemParameter(TablesColumnFile.currentAddressCode, 0);
      if(sysBean !=null&&sysBean.mcodevalue!=null){
        try{
          prefs.setInt(TablesColumnFile.currentAddressCode, int.parse(sysBean.mcodevalue));
        }
        catch(_){
      ...
      sysBean = new SystemParameterBean();
      sysBean = await AppDatabase.get().getSystemParameter(TablesColumnFile.misIndividual, 0);
      ...
      sysBean = new SystemParameterBean();
      sysBean = await AppDatabase.get().getSystemParameter(TablesColumnFile.resAddCode, 0);
      prefs.setInt(TablesColumnFile.resAddCode, 1);
      if(sysBean!=null){
        try{
          prefs.setInt(TablesColumnFile.resAddCode, int.parse(sysBean.mcodevalue));
        }catch(_){
      ...
      sysBean = new SystemParameterBean();
      sysBean = await AppDatabase.get().getSystemParameter(TablesColumnFile.businessAddCode, 0);
      prefs.setInt(TablesColumnFile.businessAddCode, 1);
      if(sysBean!=null){
        try{
          prefs.setInt(TablesColumnFile.businessAddCode, int.parse(sysBean.mcodevalue));
        }catch(_){
      ...
      sysBean = new SystemParameterBean();
      sysBean = await AppDatabase.get().getSystemParameter(TablesColumnFile.ISFULLERTON, 0);
      if(sysBean !=null&&sysBean.mcodevalue!=null){
        try{
          prefs.setInt(TablesColumnFile.ISFULLERTON, int.parse(sysBean.mcodevalue));
        }
        catch(_){
      ...
      sysBean = new SystemParameterBean();
      sysBean = await AppDatabase.get().getSystemParameter(TablesColumnFile.ISONLYLONGNAME, 0);
      if(sysBean !=null&&sysBean.mcodevalue!=null){
        try{
          prefs.setInt(TablesColumnFile.ISONLYLONGNAME, int.parse(sysBean.mcodevalue));
        }
        catch(_){
      ...
      sysBean = new SystemParameterBean();
      sysBean = await AppDatabase.get().getSystemParameter(TablesColumnFile.AGEVALIDATION, 0);
      if(sysBean !=null&&sysBean.mcodevalue!=null){
        try{
         List listValue;
          ...
          try{
             prefs.setInt(TablesColumnFile.AGEVALIDATIONMIN, int.parse(listValue[0]));
          }catch(_){}

         try{
           prefs.setInt(TablesColumnFile.AGEVALIDATIONMAX, int.parse(listValue[1]));
         }catch(_){}
      ...
      sysBean = new SystemParameterBean();
      sysBean = await AppDatabase.get().getSystemParameter(TablesColumnFile.SpouseDeclarationTab, 0);
      if(sysBean !=null&&sysBean.mcodevalue!=null){
        try{
	  ...
	  sysBean = new SystemParameterBean();
      sysBean = await AppDatabase.get().getSystemParameter(TablesColumnFile.NIDDEFAULTTYPE, 0);
      if(sysBean !=null&&sysBean.mcodevalue!=null){
        try{
          prefs.setInt(TablesColumnFile.NIDDEFAULTTYPE, int.parse(sysBean.mcodevalue));
        }
        catch(_){
    ...
    sysBean = new SystemParameterBean();
    sysBean = await AppDatabase.get().getSystemParameter(TablesColumnFile.rsfLbrCodes, 0);
    if(sysBean !=null&&sysBean.mcodevalue!=null){
      try{
...
<<<<<<< .mine
    ...
    if(sysBean!=null){
      ...
      try {
        await setCustomerTabDisplay();
=======
    sysBean = await AppDatabase.get().getSystemParameter(TablesColumnFile.chargesCodes, 0);
    if(sysBean !=null&&sysBean.mcodevalue!=null){
      try{
...
>>>>>>> .r1143
      ...
      sysBean = new SystemParameterBean();
      sysBean = await AppDatabase.get().getSystemParameter(TablesColumnFile.MANDATORYCOLOR, 0);
      if(sysBean !=null&&sysBean.mcodevalue!=null) {
        try {
      ...
      sysBean = new SystemParameterBean();
      sysBean = await AppDatabase.get().getSystemParameter(TablesColumnFile.PROJECTCODE, 0);
      if(sysBean !=null){
  ...
  static setCustomerTabDisplay() async{
    ...
    for(int tabNo=1;tabNo<15;tabNo++) {
      // int tabPos = tabNo+1;
      await AppDatabase.get().getSystemParameter('ISCUSTTAB'+tabNo.toString(), 0).then((
          onValue) {
        //print("tabNo"+tabNo.toString());
        // print("'ISCUSTTAB'+tabPos.toString()"+'ISCUSTTAB'+tabNo.toString());
        if (onValue != null && onValue.mcodevalue != null &&
            onValue.mcodevalue.trim() != '' && onValue.mcodevalue.trim()=="1") {
          if(tabNo==1)
            isCustTab1Show = false;
          if(tabNo==2)
            isCustTab2Show =false;
          if(tabNo==3)
            isCustTab3Show =false;
          if(tabNo==4)
            isCustTab4Show =false;
          if(tabNo==5)
            isCustTab5Show =false;
          if(tabNo==6)
            isCustTab6Show =false;
          if(tabNo==7)
            isCustTab7Show =false;
          if(tabNo==8)
            isCustTab8Show =false;
          if(tabNo==9)
            isCustTab9Show =false;
          if(tabNo==10)
            isCustTab10Show =false;
          if(tabNo==11)
            isCustTab11Show =false;
          if(tabNo==12)
            isCustTab12Show =false;
          if(tabNo==13)
            isCustTab13Show =false;
          if(tabNo==14)
            isCustTab14Show =false;
        }
      });
    }
  }
  static syncingUserAccessRightsData(username,usrGrpCode) async {
    ...
    try {
      await syncingUserAccessRights.getUserRightBean(username, usrGrpCode)
          .then((onValue) {
  ...
  static getAccessRights(UserRightBean beanGet) async{
    ...
    await AppDatabase.get().getUserRights(beanGet,"GRIDDASHBOARD").then((onvalue) {
    ...
    await AppDatabase.get().getUserRights(beanGet,'LOANDASHBOARD').then((onvalue) {
      // for (int addMenus = 0; addMenus < onvalue.length; addMenus++) {
  ...
  static seySyncedUserMaster() async{
    ...
    await AppDatabase.get()
        .deletSomeSyncingActivityFromOmni('MENUS_MASTER');
    for (int i = 0; i < menuMasterBean.length; i++) {
      await AppDatabase.get().updateMenuMaster(menuMasterBean[i]);
    }
  }
  static Future<List<TimelineModel>> generateeTimlineList(
      BuildContext context,

      List<LoanLevel> loanLevelList,
    ...
    for(  LoanLevel loanLevel in loanLevelList){
      ...
      if(loanLevel.mbuttonid==1){
        model =
            TimelineModel(generaateTimemline(
                context,
                loanObject.mrefno,
                loanObject.trefno,
                ...
                position:positionHolderBool? TimelineItemPosition.left:TimelineItemPosition.right,
        ...
        model =
            TimelineModel(generaateTimemline(context,loanObject.mrefno,
                loanObject.trefno,
                loanObject.mprdacctid,
                loanObject.mleadsid,
                loanLevel.mbuttonid,
      ...
      //width: MediaQuery.of(context).size.width,
        child: new GestureDetector(
          ...
          onTap: (){
            ...
            Constant.openOnBasesOfMenuId(context, mrefno,
                trefno,
                mprcdaccid,
                leadId,
                forWhat,
                      ...
                      children: <Widget>[
                        new Row(
                          ...
                          children: <Widget>[
                            ...
                            new Text("${lastUpdatedt==null?
                            formatter.format(DateTime.now()):formatter.format(lastUpdatedt)}",style: TextStyle(fontSize: 8.0),)
  ...
  static void openOnBasesOfMenuId(
    ...
    if(forWhat==3) {
      Navigator.push(
        ...
        new MaterialPageRoute(
            builder: (context) =>
            new CustomerLoanCPVBusinessRecord(globals.globalCPVBusinessObject,loanObject)), //When Authorized Navigate to the next screen
      );
    }
    if(forWhat==4) {
      Navigator.push(
        ...
        new MaterialPageRoute(
            builder: (context) =>
            new SocialAndEnvironmental(globals.globalSocialAndEnvObject,loanObject)), //When Authorized Navigate to the next screen
      );
    }
    if(forWhat==5) {
      Navigator.push(
        ...
        new MaterialPageRoute(
            builder: (context) =>
            new KycMaster(globals.globalKycMasterObj,loanObject)),  //When Authorized Navigate to the next screen
      );
    }
    if(forWhat==6) {
      Navigator.push(
        ...
        new MaterialPageRoute(
            builder: (context) =>
            new TradeAndNeighbourRefCheck(globals.globalTradeAndNeigObject,loanObject)), //When Authorized Navigate to the next screen
      );
    }
    if(forWhat==7) {
      Navigator.push(
        ...
        new MaterialPageRoute(
            builder: (context) =>
            new DeviationForm(globals.globalDeviationFormObject,loanObject)), //When Authorized Navigate to the next screen
      );
    }
    if(forWhat==8) {
      Navigator.push(
        ...
        new MaterialPageRoute(
            builder: (context) =>
            new CustomerLoanCashFlow(globals.globalCashFlowObject,loanObject)), //When Authorized Navigate to the next screen
      );
    }
    if(forWhat==9) {
      Navigator.push(
